		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#kendorcloudemployee2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"kendorcloudemployee2-display": {
								"semanticObject": "kendorcloudemployee2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=kendorcloud.employee2",
									"url": sap.ui.require.toUrl("kendorcloud/employee2")
								}
							}
						}
					}
